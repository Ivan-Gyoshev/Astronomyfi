...
namespace Astronomyfi.Data.Migrations
{
    ...
    [Migration("20210803114812_ExpandUserEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Astronomyfi.Data.Models.ForumRole", b =>
                {
            ...
            modelBuilder.Entity("Astronomyfi.Data.Models.ForumUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Astronomyfi.Data.Models.News", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Astronomyfi.Data.Models.Comment", b =>
                {
                    b.HasOne("Astronomyfi.Data.Models.ForumUser", "Author")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("Astronomyfi.Data.Models.ForumRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Astronomyfi.Data.Models.ForumUser", null)
                        .WithMany("Claims")
